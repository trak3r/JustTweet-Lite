...
// you implement presentWebView: (see below).  Launching Safari will close your
// application and make it more difficult for the user to return to your application.
//
